...
(() => {
  ...
  function U(e) {
    ...
    if (s.params.threshold && Math.sqrt(h ** 2 + u ** 2) < s.params.threshold)
      return;
    if (void 0 === i.isScrolling) {
      ...
      (s.isVertical() && r.currentX === r.startX)
        ? (i.isScrolling = !1)
        : h * h + u * u >= 25 &&
          ((e = (180 * Math.atan2(Math.abs(u), Math.abs(h))) / Math.PI),
  ...
  function K(e) {
    ...
    for (
      ...
      void 0 !== o[e + t]
        ? p >= o[e] && p < o[e + t] && ((h = e), (u = o[e + t] - o[e]))
        : p >= o[e] && ((h = e), (u = o[o.length - 1] - o[o.length - 2]));
    }
    let g = null,
      m = null;
    i.rewind &&
  ...
  const re = {
    setBreakpoint: function () {
      ...
      h && s && e.changeDirection(), _(e.params, l);
    ...
    s({
      ...
      i("click", (e, s) => {
        const { $nextEl: i, $prevEl: r } = t.navigation,
          o = s.target;
        if (t.params.navigation.hideOnClick && !L(o).is(r) && !L(o).is(i)) {
          if (
            t.pagination &&
            t.params.pagination &&
  ...
  function fe(e) {
    ...
    function c() {
      ...
      if (
        ("fraction" === s.type &&
          (r.find(me(s.currentClass)).text(s.formatFractionCurrent(c + 1)),
          r.find(me(s.totalClass)).text(s.formatFractionTotal(p))),
        "progressbar" === s.type)
      ) {
        let e;
    ...
    ye(),
      document.querySelector(".slider-main__slider") &&
        new he(".slider-main__slider", {
          ...
          preloadImages: !1,
          parallax: !0,
          pagination: { el: ".controls-main-slider__dotts", clickable: !0 },
          navigation: {
    ...
    st = (function () {
      ...
      return (
        ...
        (e.prototype.openGallery = function (e, t) {
          ...
          if ((void 0 === e && (e = this.settings.index), !this.lgOpened)) {
            ...
            this.zoomFromOrigin &&
              ...
              (r = Re(t, this.outer, a, l, this.currentImageSize))),
        ...
        (e.prototype.loadContent = function (e, t) {
          ...
          if (
            ...
            if (m) {
              ...
              S = Qe(r, x || "", g, this.settings.strings.playVideo, u);
              n.prepend(S);
            } else if (u) {
        ...
        (e.prototype.closeGallery = function (e) {
          ...
          this.LGel.trigger(Ge), qe(window).scrollTop(this.prevScrollTop);
          var s,
  ...
  nt.length &&
    nt.forEach((e) => {
      it(e, { licenseKey: "7EC452A9-0CFD441C-BD984C7C-17C8456E", speed: 500 });
    }),
    (window.onload = function () {
      document.addEventListener("click", function (e) {
        ...
        t.classList.contains("products__more") &&
          (getProducts(t), e.preventDefault());
      });
    }),
    (window.FLS = !0),
    (function (e) {
    ...
    (function () {
      ...
      function l(e) {
        ...
        } else "resize" === d && (t.length && o(t), s.length && r(s));
      }
      e.length &&
